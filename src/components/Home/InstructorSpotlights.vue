    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12 animate-fade-in">
        <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          Meet Our <span class="text-teal-700">Experts</span>
        </h2>
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in-up">
        <div 
          ...
          :key="instructor.id"
          class="section-shell interactive-lift overflow-hidden"
        >
          <div class="p-6 text-center">
            ...
            <div class="mb-4">
              ...
              <p class="text-teal-700 font-medium">{{ instructor.title }}</p>
              <p class="text-slate-600 mt-2">{{ instructor.bio }}</p>
            </div>
