    ...
    <div class="w-full max-w-2xl rounded-2xl bg-white shadow-2xl">
      ...
      <div class="px-6 py-5">
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div>
            <label class="text-xs font-semibold text-slate-600">Level</label>
            <input v-model="form.level" type="text" placeholder="Beginner / Intermediate" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" />
          </div>
          <div>
...
watch(
  ...
  (value) => {
    if (value && props.course) {
      ...
      form.shortDescription = props.course.shortDescription || "";
