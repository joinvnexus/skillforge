...
export const env = {
  ...
  JWT_EMAIL_CHANGE_SECRET: process.env.JWT_EMAIL_CHANGE_SECRET || process.env.JWT_ACCESS_SECRET,
  JWT_ACCESS_EXPIRES_IN: process.env.JWT_ACCESS_EXPIRES_IN || "15m",
  JWT_REFRESH_EXPIRES_IN: process.env.JWT_REFRESH_EXPIRES_IN || "30d",
  JWT_PASSWORD_RESET_EXPIRES_IN: process.env.JWT_PASSWORD_RESET_EXPIRES_IN || "30m",
  JWT_EMAIL_CHANGE_EXPIRES_IN: process.env.JWT_EMAIL_CHANGE_EXPIRES_IN || "30m",
  PAYMENT_WEBHOOK_SECRET: process.env.PAYMENT_WEBHOOK_SECRET || "dev-payment-webhook-secret"
};
